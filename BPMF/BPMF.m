function score = BPMF( train_rating, maxepoch, num_feat )
% Version 1.000
%
    ...
    for gibbs=1:2
      %  fprintf(1,'\t\t Gibbs sampling %d \r', gibbs);
        ...
        for mm=1:num_m
            ...
            covar(isnan(covar)) = 0;%我加的
            covar(isinf(covar)) = 0;%我加的
...
score = w1_P1_sample * w1_M1_sample' + mean_rating;
