...
train = (load('D:\链路预测相关课题\基于用户-物品的推荐\时间上下文信息数据集\MovieLens\ml-100k\u4.base'));
test = (load('D:\链路预测相关课题\基于用户-物品的推荐\时间上下文信息数据集\MovieLens\ml-100k\u4.test'));% 不知道为什么，这里的test在第460多位用户之后没有相关数据！
...
sim = jaccard_item_similarity( ratingTrain_norm);
